...
#include "geometry/BoostGeometryRegister.hpp"
#include "geometry/BoostPolygonRegister.hpp"
#include "geometry/BooleanOperation.hpp"
...
using t_geometry_num_types = boost::mpl::list<int, float, double, long int, long double>;
